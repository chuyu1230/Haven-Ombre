...
class ReflectionEngine:
    ...
    async def _write_daily_chat_memory_candidates(
        ...
        *,
        ...
        logger.info("DEBUG entering _write_daily_chat_memory_candidates with candidates=%r", candidates)
        results = []
    ...
    def _save_daily_chat_memory_pending(self, items: list[dict], *, cursor: dict | None = None) -> None:
        logger.info("DEBUG entering _save_daily_chat_memory_pending with items=%r", items)
